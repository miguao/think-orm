...
export const cropperProps = {
  ...
  tools: {
    type: String,
    default:
      'zoomIn,zoomOut | moveLeft,moveRight,moveUp,moveDown | rotateLeft,rotateRight | flipX,flipY | reset,upload | ok'
  },
  /** 是否需要预览组件 */
  preview: {
    type: Boolean,
  ...
  toBlob: Boolean,
  /** cropperjs的参数 */
  options: Object as PropType<CropperOptions>,
  /** cropperjs裁剪方法的参数 */
  croppedOptions: Object as PropType<CroppedOptions>,
  /** 是否需要tooltip */
  tooltip: {
    type: Boolean,
    default: true
