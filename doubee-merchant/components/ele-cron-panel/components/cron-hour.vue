    ...
    <ElRadioGroup v-model="type">
      ...
      <ElRadio value="range" class="ele-cron-panel-item-wrapper">
        <div class="ele-cron-panel-item">
          ...
          <div>&emsp;{{ lang.hourRange }}&emsp;</div>
          <div class="ele-cron-panel-item-input">
            <ElInputNumber
              v-model="end"
              :min="endMin"
          ...
          <div>&emsp;{{ lang.hourRangeEnd }}</div>
        </div>
      </ElRadio>
      <ElRadio value="interval" class="ele-cron-panel-item-wrapper">
        <div class="ele-cron-panel-item">
          <div>{{ lang.hourIntervalStart }}&emsp;</div>
          <div class="ele-cron-panel-item-input">
            <ElInputNumber
          ...
          <div>&emsp;{{ lang.hourInterval }}&emsp;</div>
          <div class="ele-cron-panel-item-input">
            <ElInputNumber
          ...
          <div>&emsp;{{ lang.hourIntervalEnd }}</div>
        </div>
      </ElRadio>
      <ElRadio
        value="specified"
...
<script lang="ts" setup>
  ...
  const emit = defineEmits({
    'update:modelValue': (_hour?: string) => true
  });
