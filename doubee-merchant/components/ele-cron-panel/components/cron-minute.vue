    ...
    <ElRadioGroup v-model="type">
      ...
      <ElRadio value="range" class="ele-cron-panel-item-wrapper">
        <div class="ele-cron-panel-item">
          ...
          <div>&emsp;{{ lang.minuteRange }}&emsp;</div>
          <div class="ele-cron-panel-item-input">
            <ElInputNumber
              v-model="end"
              :min="endMin"
          ...
          <div>&emsp;{{ lang.minuteRangeEnd }}</div>
        </div>
      </ElRadio>
      <ElRadio value="interval" class="ele-cron-panel-item-wrapper">
        <div class="ele-cron-panel-item">
          <div>{{ lang.minuteIntervalStart }}&emsp;</div>
          <div class="ele-cron-panel-item-input">
            <ElInputNumber
          ...
          <div>&emsp;{{ lang.minuteInterval }}&emsp;</div>
          <div class="ele-cron-panel-item-input">
            <ElInputNumber
          ...
          <div>&emsp;{{ lang.minuteIntervalEnd }}</div>
        </div>
      </ElRadio>
      <ElRadio
        value="specified"
...
<script lang="ts" setup>
  ...
  const emit = defineEmits({
    'update:modelValue': (_minute?: string) => true
  });
