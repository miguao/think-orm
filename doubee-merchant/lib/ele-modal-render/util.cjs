...
const ModalLoading = require("./components/modal-loading");
...
function getItemComponent(item, onLoaded) {
  ...
  if (component && typeof component === "object") {
    return [vue.markRaw(component), false];
  }
  if (component != null) {
  ...
  if (custom) {
    const comp2 = vue.defineAsyncComponent({
      loadingComponent: ModalLoading,
      ...asyncComponentOptions || {},
      loader: asyncComponent
    });
    return [vue.markRaw(comp2), false];
  }
...
exports.MODAL_HOLDER_KEY = MODAL_HOLDER_KEY;
exports.MODAL_UTIL_KEY = MODAL_UTIL_KEY;
exports.useModalRender = useModalRender;
exports.useModalRenderProvider = useModalRenderProvider;
