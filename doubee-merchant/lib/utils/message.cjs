...
function getWrapEl(bodyEl, force, groupKey) {
  ...
  const el = force ? void 0 : common.queryChild(parent, className, attrSelector);
  if (el != null) {
    return el;
  }
...
function normalizeOption(params, globalOpt, onClose, type, loading, getWrapEl2, groupKey, messageId, onMessageDestroy) {
  ...
  opt.appendTo = (opt.appendTo == null ? void 0 : vue.unref(opt.appendTo)) ?? getWrapEl2?.(opt.inner);
