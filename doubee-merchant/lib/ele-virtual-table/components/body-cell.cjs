...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const cellText = vue.computed(() => {
      ...
      return common.getValue(props.rowData, prop);
    });
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("div", {
          ...
          isExpandCol.value ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
            __props.rowIndent ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 0,
              class: "ele-table-indent",
              style: vue.normalizeStyle({ width: __props.rowIndent })
            }, null, 4)) : vue.createCommentVNode("", true),
            __props.hasChildren ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 1,
              class: vue.normalizeClass(["ele-table-expand", { "is-collapse": __props.isCollapse }]),
              onClick: vue.withModifiers(handleExpandChange, ["stop"])
            }, [
              vue.createVNode(vue.unref(elementPlus.ElIcon), {
                class: vue.normalizeClass({ "is-loading": __props.loading })
              }, {
                default: vue.withCtx(() => [
                  __props.loading ? (vue.openBlock(), vue.createBlock(vue.unref(index.LoadingDotOutlined), { key: 0 })) : (vue.openBlock(), vue.createBlock(vue.unref(index.ArrowDown), { key: 1 }))
                ]),
                _: 1
              }, 8, ["class"])
            ], 2)) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_1))
          ], 64)) : vue.createCommentVNode("", true),
          colType.value === "selection" ? (vue.openBlock(), vue.createBlock(CellCheckbox, {
            key: 1,
            checked: __props.isChecked,
            disabled: __props.isDisabled,
            size: __props.tableSize,
            onChange: handleCheckedChange
          }, null, 8, ["checked", "disabled", "size"])) : colType.value !== "expand" ? (vue.openBlock(), vue.createBlock(vue.unref(util.CellRender), vue.normalizeProps(vue.mergeProps({ key: 2 }, renderOpt.value)), {
            default: vue.withCtx(() => [
              vue.createTextVNode(vue.toDisplayString(cellText.value), 1)
            ]),
            _: 1
