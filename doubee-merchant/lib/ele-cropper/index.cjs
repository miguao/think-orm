  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["ele-cropper", { "is-responsive": vue.unref(isResponsive) }])
      }, [
        vue.createElementVNode("div", _hoisted_1, [
          ...
          _ctx.preview ? (vue.openBlock(), vue.createBlock(CropperPreview, {
            key: 0,
            ref_key: "previewRef",
            ref: previewRef,
