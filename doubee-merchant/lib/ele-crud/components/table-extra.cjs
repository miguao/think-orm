  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        __props.addConfig !== false ? (vue.openBlock(), vue.createBlock(EditModal, {
          key: 0,
          ...
          vue.renderList(Object.keys(_ctx.$slots).filter(
            ...
            return {
              ...
              fn: vue.withCtx((slotProps) => [
                vue.renderSlot(_ctx.$slots, name, vue.normalizeProps(vue.guardReactiveProps(slotProps || void 0)))
              ])
            };
          })
